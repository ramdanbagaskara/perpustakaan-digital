        ...
        <?= form_open('buku/create'); ?>
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="number" name="tahun_terbit" class="form-control" value="<?= set_value('tahun_terbit'); ?>" min="1900" max="2100">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Stok</label>
                    <input type="number" name="stok" class="form-control" value="<?= set_value('stok'); ?>" min="0" required>
                </div>
                <div class="col-md-6">
                    <label class="form-label">Kategori</label>
                    <input type="text" name="kategori" class="form-control" value="<?= set_value('kategori'); ?>" placeholder="Novel, Sains, Teknologi, dll">
                </div>
                <div class="col-12">
